...
Before any growth work, audit the current X presence:
...
- Number the tweets or use a down arrow in tweet 1
```
...
Add your unique take to an existing tweet. Never just say "This" or "So true."
...
- Threads with inconsistent quality
...
## Step 4 — Growth Playbook

### Week 1-2: Foundation
1. Optimize bio and pinned tweet
...
3. Build reply relationships with 5-10 accounts your size
...
- `linkedin-post-writer` — LinkedIn-specific post writing
- `linkedin-content-planner` — LinkedIn content calendar planning
