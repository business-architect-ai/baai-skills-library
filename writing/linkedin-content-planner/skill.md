...
- **Theme** (optional): e.g., "AI agents shipping in production", "first 6 months of building X"
...
- **3-5 creators to engage** (names or archetypes)
...
- **3-5 posts per week.** 6+/week triggers cannibalization signal.
...
3. For each posting day, pick pillar, formula, format, angle, posting time.
...
- `linkedin-humanizer` — audit drafts before posting
